...
def story_accueil():
    ...
    return html.Div([
        ...
        html.
        P("Pour revenir à cette page, cliquez sur le bouton 'Accueil' dans la barre de navigation."
          ),
        html.
        P("Pour des données à jour, utilisez le bouton 'Mettre à jour les données'. Cela peut prendre plusieurs minutes, soyez patient."
          ),
        dmc.Divider(size="md", style={"marginBottom": "2rem"}),
        dmc.Blockquote(

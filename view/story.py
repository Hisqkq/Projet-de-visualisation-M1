...
def story_accueil():
    ...
    cards = [
        dmc.Card(
            ...
            children=[
                ...
                html.Div(dcc.Markdown(card["image_credits"]),
    ...
    cards_data_content = [
        {
            ...
            "Données nationales",
            "text":
            "Consultez les données nationales sur la production, la consommation et les échanges d'électricité. Les données sont disponibles en temps réel et consolidées. Pour plus de détails, cliquez sur l'un des boutons ci-dessous.",
            "image":
            "/assets/donnees_nationales.jpg",
            "image_credits":
            "Image credits: Europe at night viewed from space, NASA",
            "links": [{
                "text":
                "Données consolidées",
                "href":
                ...
                "href":
                "https://odre.opendatasoft.com/explore/dataset/eco2mix-national-tr/information/?flg=fr-fr&disjunctive.nature"
            }]
        },
        {
            "title":
            "Données régionales",
            "text":
            "Explorez les données régionales sur la production et la consommation d'électricité. Les données sont disponibles en temps réel et consolidées. Pour plus de détails, cliquez sur l'un des boutons ci-dessous.",
            "image":
            "/assets/donnees_regionales.jpg",
            "image_credits":
            "Image credits: photo by Éric Soulé de Lafont",
            "links": [{
                "text":
                "Données consolidées",
                "href":
                "https://odre.opendatasoft.com/explore/dataset/eco2mix-regional-cons-def/information/?disjunctive.libelle_region&disjunctive.nature "
            }, {
                "text":
                "Données en temps réel",
                "href":
                "https://odre.opendatasoft.com/explore/dataset/eco2mix-regional-tr/information/?disjunctive.libelle_region&disjunctive.nature"
            }]
        },
    ]
    ...
    cards_data = [
        dmc.Card(
            ...
            children=[
                ...
                dmc.Text(card["text"], style={"color": "#DDD"}),
                html.Div([
                    dcc.Link(dmc.Button(link["text"],
                                        color="primary",
                                        style={"marginRight": "10px"}),
                             href=link["href"],
                             target="_blank") for link in card["links"]
                ],
    ...
    return html.Div([
        html.
        H6("Veuillez cliquer sur l'un des trois graphiques ci-dessus pour explorer une problématique.",
           className="text-center mb-4"),
        dmc.Divider(size="md", style={"marginBottom": "2rem"}),
        html.H5("Les trois grands sujets de l'électricité en France",
                className="mb-4"),
        ...
        html.
        P("Ce dashboard a été réalisé dans le cadre de l'Unité d'Enseignement Projet de Visualisation Analytique du CMI ISI. Il a été développé par Louis Delignac, Théo Lavandier et Hamad Tria. Le code source est disponible sur Github."
          ),
        dmc.Divider(size="md", style={"marginBottom": "2rem"}),
        dmc.Blockquote(
        ...
        html.Footer(
            html.
            P("Les données utilisées pour ce dashboard proviennent de sources officielles et sont mises à jour en continu.",
...
def story_consommation():
    cards_content = [
        {
            ...
            "image":
            "/assets/consommation.jpg",
            "image_credits":
            "Image credits: Kowit Lanchu/Shutterstock.com",
        },
        {
            "title":
            "Les Prédictions de Consommation par RTE",
            "text":
            ...
            "image":
            "/assets/previsions.png",
            "image_credits":
            "Image credits: DALL.E, AI generated picture",
        },
    ]
    ...
    cards_consumption_graphs = [
        {
            "title":
            "Carte de la Consommation Régionale",
            "text":
        ...
        {
            "title":
            "Courbe de Consommation et de prévision",
            "text":
        ...
        {
            "title":
            "Analyse de la Consommation par Région",
            "text":
    ...
    return dmc.Container([
        dmc.Title("La Consommation d'Électricité en France",
                  order=2,
                  style={"color": "#FFF"}),
        dmc.SimpleGrid(cols=2, spacing="lg", children=cards),
        dmc.SimpleGrid(cols=3, spacing="lg", children=cards_graphs),
    ],
                         fluid=True,
                         style={"maxWidth": 1200})
...
def story_production():
    cards_content = [
        {
            ...
            "image":
            "/assets/nucleaire.jpg",
            "image_credits":
            "Image credits: Getty Images, yangna",
        },
        {
            "title":
            ...
            "image":
            "/assets/renouvelable.jpg",
            "image_credits":
            "Image credits: iStock, Petmal ",
        },
    ]
    ...
    cards_graphs_content = [{
        ...
        "title":
        "Carte animée de la Production d'Électricité des énergies renouvelables",
        "text":
...
def story_echanges():
    return dmc.Container([
        ...
        dmc.Card(
            children=[
                dmc.Text("Carte de la France et ses pays frontaliers",
                         weight=500,
                         size="lg",
                         style={"color": "#FFF"}),
                dmc.Text(
                ...
                dmc.Image(src="/assets/europe.png",
                          height=740,
                          fit="cover",
                          style={
                              "borderTopLeftRadius": "8px",
                ...
                html.Div(dcc.Markdown('Image credits: Google Maps'),
                         className="image-credits",
                         style={
                             "fontSize": "0.7rem",
                             "color": "grey",

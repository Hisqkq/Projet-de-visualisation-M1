...
def layout():
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
            dmc.Switch(
                id="switch-background-map",
                offLabel=DashIconify(icon="tabler:background", width=20),
...
def update_map(dates, checked, fig):
    ...
    if trigger_id == "date-range-picker":
        ...
        if checked:
            ...
            fig['layout']['mapbox']['style'] = "mapbox://styles/tlavandier/clqmy8zxa00qt01o3ax462t6g"

...
def layout():
    return dbc.Container([
        ...
        dbc.Row([
            ...
            html.Div([
                html.H4("Production régionale par source d'énergie",
        ...
        dbc.Row([
            ...
            html.
            H4("Évolution de la production moyenne d'énergie renouvelable par an",
               className="text-center mb-3"),
            dcc.Graph(id="map_renewable_production_animation",
